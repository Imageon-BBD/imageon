...
resource "aws_instance" "api_server" {
  ...
  user_data = <<-EOF
              ...
              git clone https://github.com/miniconomy2025/imageon.git /home/ubuntu/imageon
              cd /home/ubuntu/imageon/backend
              npm install
              npm run build
              npm install -g pm2
              pm2 start dist/src/app.js --name imageon-backend
            EOF
  tags = {
    Name = "imageon-api"
  }
...
resource "aws_instance" "frontend_server" {
  ...
  user_data = <<-EOF
              ...
              git clone https://github.com/miniconomy2025/imageon.git /var/www/frontend
...
resource "aws_budgets_budget" "imageon_budget" {
  name              = "imageon_budget"
  budget_type       = "COST"
  limit_amount      = "25"
  limit_unit        = "USD"
